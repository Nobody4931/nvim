	...
	-- Configuration tool for the native Neovim LSP client
	{
		...
		config = function(_, opts)
			...
			local function on_attach(client, bufnr)
				...
				map("n", "<leader>lW", function() require("telescope.builtin").lsp_dynamic_workspace_symbols() end, map_opt)
				...
				map("n", "<leader>lG", function() require("telescope.builtin").diagnostics() end, map_opt)

				map("n", "]d", function() vim.diagnostic.goto_next() end, map_opt)
				map("n", "[d", function() vim.diagnostic.goto_prev() end, map_opt)
				map("n", "]D", function() vim.diagnostic.goto_next({ severity = vim.diagnostic.severity.ERROR }) end, map_opt)
				map("n", "[D", function() vim.diagnostic.goto_prev({ severity = vim.diagnostic.severity.ERROR }) end, map_opt)
			end
